...
})({"lImHF":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = 1234;
...
if (signupForm) signupForm.addEventListener("submit", async (e)=>{
    ...
    const html = await (0, _login.signup)(name, email, password, passwordConfirm);
    if (!html) {
        password.value = "";
...
if (document.body) document.body.addEventListener("click", function(e) {
    ...
    if (e.target.classList.contains("arrow-left-circle")) window.history.back();
...
},{"core-js/modules/es.symbol.description.js":"hgu4d","core-js/modules/es.array.flat.js":"lRn13","core-js/modules/es.array.flat-map.js":"gM669","core-js/modules/es.array.sort.js":"PLp5i","core-js/modules/es.array.unscopables.flat.js":"88nm6","core-js/modules/es.array.unscopables.flat-map.js":"2tF7j","core-js/modules/es.math.hypot.js":"bPuQ3","core-js/modules/es.object.from-entries.js":"98OZX","core-js/modules/es.promise.js":"5t0IQ","core-js/modules/es.promise.finally.js":"c5ALq","core-js/modules/es.regexp.flags.js":"kZ4xK","core-js/modules/es.typed-array.set.js":"8AABK","core-js/modules/es.typed-array.sort.js":"gqGeA","core-js/modules/web.queue-microtask.js":"eRNJq","regenerator-runtime/runtime":"regenerator-runtime/runtime","./leaflet":"58ZVV","./login":"qZEOz","./updateSettings":"28JcJ","./flutter":"9ZyZc","./pinLogin":"bzJZ9","@parcel/transformer-js/src/esmodule-helpers.js":"5Birt"}],"hgu4d":[function(require,module,exports) {
...
},{"6f7278673cd963e5":"koDCM","6aa13a6bc9f9574a":"3WC9j","b80db4539abf09d9":"kMnY0","889c274f5e23b39":"k1vB2","15983ab5c2fbc059":"cETeD","48970736383a6aba":"cvjKV"}],"58ZVV":[function(require,module,exports) {
/* eslint-disable */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"axios":"axios","./alerts":"j4hQk","@parcel/transformer-js/src/esmodule-helpers.js":"5Birt"}],"j4hQk":[function(require,module,exports) {
/* eslint-disable */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const updateSettings = async (data, type)=>{
    try {
        const url = type === "password" ? "/api/v4/users/updatePassword" : "/api/v4/users/updateMe";
        const res = await (0, _axiosDefault.default)({
            method: "PATCH",
            url,
            data
...
},{"axios":"axios","./alerts":"j4hQk","@parcel/transformer-js/src/esmodule-helpers.js":"5Birt"}],"9ZyZc":[function(require,module,exports) {
/* eslint-disable */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"axios":"axios","./alerts":"j4hQk","@parcel/transformer-js/src/esmodule-helpers.js":"5Birt"}],"bzJZ9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>SigninTokenFunctionality);
...
class SigninTokenFunctionality {
    ...
    constructor(){
        // Get pin container
        (0, _defineProperty._)(this, "pinContainer", document.querySelector("#pin-input"));
        (0, _defineProperty._)(this, "pinValueContainer", document.querySelector("#pin-value"));
        (0, _defineProperty._)(this, "submitButton", document.querySelector("#submit"));
        (0, _defineProperty._)(this, "firstInput", this.pinContainer.querySelector("input"));
        (0, _defineProperty._)(this, "inputs", this.pinContainer.querySelectorAll("input:not(#pin-value)"));
        (0, _defineProperty._)(this, "updateValue", (inputs)=>{
            this.pinValueContainer.value = Array.from(inputs).reduce((acc, curInput)=>acc.concat(curInput.value ? curInput.value : "*"), "");
        });
        (0, _defineProperty._)(this, "isValidInput", (inputValue)=>{
            return Number(inputValue) === 0 && inputValue !== "0" ? false : true;
        });
        (0, _defineProperty._)(this, "setInputValue", (inputElement, inputValue)=>{
            inputElement.value = inputValue;
        });
        (0, _defineProperty._)(this, "resetInput", (inputElement)=>{
            this.setInputValue(inputElement, "");
        });
        (0, _defineProperty._)(this, "focusNext", (inputs, curIndex)=>{
            const nextElement = curIndex < inputs.length - 1 ? inputs[curIndex + 1] : inputs[curIndex];
            nextElement.focus();
            nextElement.select();
        });
        (0, _defineProperty._)(this, "focusPrev", (inputs, curIndex)=>{
            const prevElement = curIndex > 0 ? inputs[curIndex - 1] : inputs[curIndex];
            prevElement.focus();
            prevElement.select();
        });
        (0, _defineProperty._)(this, "focusIndex", (inputs, index)=>{
            const element = index < inputs.length - 1 ? inputs[index] : inputs[inputs.length - 1];
            element.focus();
            element.select();
        });
        (0, _defineProperty._)(this, "handleValidMultiInput", (inputElement, inputValue, curIndex, inputs)=>{
        ...
        (0, _defineProperty._)(this, "handleInput", (inputElement, inputValue, curIndex, inputs)=>{
        ...
        (0, _defineProperty._)(this, "handleValidSingleInput", (inputElement, inputValue, curIndex, inputs)=>{
            this.setInputValue(inputElement, inputValue.slice(-1));
            this.focusNext(inputs, curIndex);
        });
        (0, _defineProperty._)(this, "handleInvalidInput", (inputElement)=>{
            this.resetInput(inputElement);
        });
        (0, _defineProperty._)(this, "handleKeyDown", (e, key, inputElement, curIndex, inputs)=>{
            if (key === "Delete") {
                this.resetInput(inputElement);
        ...
        (0, _defineProperty._)(this, "handleKeyUp", (event, key, inputElement, curIndex, inputs)=>{
...
},{"@swc/helpers/_/_define_property":"i3z5h","@parcel/transformer-js/src/esmodule-helpers.js":"5Birt"}],"i3z5h":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"5Birt"}]},["lImHF","4uyBp"], "4uyBp", "parcelRequire11c7")
