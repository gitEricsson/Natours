...
})({"ex8Fy":[function(require,module,exports) {
...
var _pinLogin = require("./pinLogin");
var _pinLoginDefault = parcelHelpers.interopDefault(_pinLogin);
// DOM ELEMENTS
...
if (loginForm) loginForm.addEventListener("submit", async (e)=>{
    ...
    const html = await (0, _login.login)(email, password);
    ...
    main.appendChild(new DOMParser().parseFromString(html, "text/html").querySelector(".main"));
...
const confirmLoginFunctionality = (email)=>{
    ...
    const activeSigninTokenFunctionality = new (0, _pinLoginDefault.default)();
    confirmLoginForm.addEventListener("submit", (e)=>{
        e.preventDefault();
        const signinToken = activeSigninTokenFunctionality.getValue();
        (0, _login.confirmLogin)(email, signinToken);
    });
};
if (document.body) document.body.addEventListener("click", function(e) {
    if (e.target.classList.contains("nav__el--logout")) (0, _login.logout)();
    if (e.target.closest(".nav__el--me") || e.target.classList.contains("nav__el--me")) (0, _login.getMe)();
    if (e.target.classList.contains("arrow-left-circle")) {
        console.log(e.target.classList);
        window.history.back();
    }
    // Function to display or hide mobile menu
    if (e.target.closest(".menu__btn") || e.target.classList.contains("menu__btn")) menuFunction();
    if (e.target.classList.contains("btn--close-modal")) menuFunction();
    if (e.target.classList.contains("overlay")) menuFunction();
});
...
if (appointments) appointments.forEach((appointment)=>{
    appointment.addEventListener("click", (e)=>{
        ...
        (0, _login.createBooking)(appointmentId, tourId);
    });
});
...
},{"core-js/modules/web.immediate.js":"49tUX","regenerator-runtime/runtime":"dXNgZ","./leaflet":"xvuTT","./login":"7yHem","./updateSettings":"l3cGY","./flutter":"7T5HG","./pinLogin":"duLIu","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"49tUX":[function(require,module,exports) {
"use strict";
...
const displayMap = (locations)=>{
    ...
    locations.forEach((loc)=>{
        ...
        const marker = L.marker(loc.coordinates.reverse(), {
            icon: icon
        }).bindPopup(popup).setPopupContent(`${loc.day}: ${loc.description}`).on("add", function() {
            marker.openPopup();
        });
...
parcelHelpers.export(exports, "confirmLogin", ()=>confirmLogin);
parcelHelpers.export(exports, "logout", ()=>logout);
parcelHelpers.export(exports, "getMe", ()=>getMe);
...
const confirmLogin = async (email, signinToken)=>{
    try {
        const res = await (0, _axiosDefault.default)({
            method: "POST",
...
(0, _axiosDefault.default).interceptors.response.use((response)=>response, async (error)=>{
    // Check for specific error codes indicating expired access token (e.g., 401)
    if (error.response && error.response.status === 401) try {
        const res = await (0, _axiosDefault.default)({
            method: "GET",
        ...
        if (res.status === 200) {
            ...
            return (0, _axiosDefault.default).request(error.config); // Retry the request with new token
        }
    } catch (err) {
...
const createBooking = async (appointmentId, tourId)=>{
    try {
        const res = await (0, _axiosDefault.default)({
            method: "POST",
...
const updateSettings = async (data, type)=>{
    try {
        const url = type === "password" ? "http://127.0.0.1:3000/api/v4/users/updatePassword" : "http://127.0.0.1:3000/api/v4/users/updateMe";
        const res = await (0, _axiosDefault.default)({
            method: "PATCH",
            url,
            data
...
},{"axios":"jo6P5","./alerts":"6Mcnf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7T5HG":[function(require,module,exports) {
/* eslint-disable */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"axios":"jo6P5","./alerts":"6Mcnf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"duLIu":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class SigninTokenFunctionality {
    // Get pin container
    ...
    constructor(){
        ...
        this.inputs.forEach((input, index)=>{
            ...
            input.addEventListener("keydown", (e)=>this.handleKeyDown(e, e.key, input, index, this.inputs));
            input.addEventListener("keyup", (e)=>this.handleKeyUp(e, e.key, input, index, this.inputs));
    ...
    updateValue = (inputs)=>{
        this.pinValueContainer.value = Array.from(inputs).reduce((acc, curInput)=>acc.concat(curInput.value ? curInput.value : "*"), "");
    };
    ...
    handleValidMultiInput = (inputElement, inputValue, curIndex, inputs)=>{
        ...
        inputsToChange.forEach((input, index)=>this.setInputValue(input, inputValue[index]));
        this.focusIndex(inputs, endIndex);
    };
    handleInput = (inputElement, inputValue, curIndex, inputs)=>{
        if (!this.isValidInput(inputValue)) return this.handleInvalidInput(inputElement);
        if (inputValue.length === 1) this.handleValidSingleInput(inputElement, inputValue, curIndex, inputs);
        else this.handleValidMultiInput(inputElement, inputValue, curIndex, inputs);
    };
...
exports.default = SigninTokenFunctionality;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["ex8Fy","f2QDv"], "f2QDv", "parcelRequire11c7")
